...
public class MeControllerTest {
	...
	void isExistFavoritePath() throws Exception {
		given(favoriteService.hasFavoritePath(any(), any(), any()))
			.willReturn(new FavoriteExistenceResponse(true));
		String expected = "{\"existence\" : " + true + "}";

		this.mockMvc.perform(
			get("/me/favorites/source/{sourceId}/target/{targetId}/existsPath", SOURCE_STATION_ID,
				TARGET_STATION_ID)
				.accept(MediaType.APPLICATION_JSON)
				.header(HttpHeaders.AUTHORIZATION, token))
			.andExpect(status().isOk())
	...
	void addFavorite() throws Exception {
		String body =
			"{\"sourceStationId\" : " + SOURCE_STATION_ID + ", \"targetStationId\" : "
				+ TARGET_STATION_ID + "}";
	...
	void removeFavorite() throws Exception {
		this.mockMvc.perform(
			RestDocumentationRequestBuilders
				.delete("/me/favorites/source/{sourceId}/target/{targetId}",
	...
	void getFavorites() throws Exception {
		...
		List<FavoriteResponse> favoriteResponses = Arrays
			.asList(new FavoriteResponse(gangbuk, gangdong),
