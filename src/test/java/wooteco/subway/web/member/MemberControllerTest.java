...
class MemberControllerTest {
	...
	void updateMember() throws Exception {
		...
		when(memberService.updateMemberByUser(any(Member.class), any(UpdateMemberRequest.class))).thenReturn(
			updatedMember);

		UpdateMemberRequest updateMemberRequest = new UpdateMemberRequest(NEW_NAME, PASSWORD);
