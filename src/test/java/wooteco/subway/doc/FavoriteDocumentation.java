...
public class FavoriteDocumentation {
    public static ResultHandler addFavorite() {
        return document("favorite/add",
                requestFields(
                        fieldWithPath("departStationId").type(JsonFieldType.STRING)
                                .description("The depart station's id"),
                        fieldWithPath("arriveStationId").type(JsonFieldType.STRING)
                                .description("The arrive station's id")
                ),
                requestHeaders(
