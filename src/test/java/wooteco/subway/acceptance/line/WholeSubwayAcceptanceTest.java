...
public class WholeSubwayAcceptanceTest extends AcceptanceTest {
    ...
    public void wholeSubway() {
        ...
        addLineStation(lineResponse2.getId(), stationResponse1.getId(),
                stationResponse5.getId());
        addLineStation(lineResponse2.getId(), stationResponse5.getId(),
                stationResponse6.getId());
