...
public class MemberAcceptanceTest extends AcceptanceTest {
    ...
    public static final String TEST_USER_EMAIL2 = "turtle@gmail.com";
    public static final String TEST_USER_NAME2 = "turtle";
    public static final String TEST_USER_PASSWORD2 = "1111";
    ...
    void manageMember() throws Exception {
        ...
        MemberResponse member = getMember(token);
        // then 회원정보가 조회된다.
        ...
        MemberResponse member2 = getMember(token2);
        ...
        // then 회원 정보가 수정되었다.
        MemberResponse shouldNotBeUpdated = getMember(token);
        ...
        // then 회원 정보가 수정되었다.
        MemberResponse updateMember = getMember(token);
        ...
        // then 회원정보가 삭제되지 않는다.
        assertThat(getMember(token).getName()).isNotNull();
        // when 사용자 인증과 함께 회원 정보 삭제 요청을 보낸다.
        deleteMember(member, token);
        // then 회원정보가 삭제된다.
        assertThat(getMember(token)).isNull();
    }
}
