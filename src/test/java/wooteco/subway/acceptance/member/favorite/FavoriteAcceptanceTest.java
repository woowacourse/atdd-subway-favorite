...
public class FavoriteAcceptanceTest extends AcceptanceTest {
	...
	private void addFavorite(Long memberId, AddFavoriteRequest addFavoriteRequest, Response loginResponse) {
	...
	private RequestSpecification setAuthorization(Response loginResponse) {
		...
		TokenResponse tokenResponse = getResponse(TokenResponse.class, loginResponse);
