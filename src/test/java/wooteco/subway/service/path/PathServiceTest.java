...
public class PathServiceTest {
	...
	void findPath() {
		...
		when(stationRepository.findByName(STATION_NAME3)).thenReturn(
			Optional.of(station3));
		when(stationRepository.findByName(STATION_NAME5)).thenReturn(
			Optional.of(station5));
