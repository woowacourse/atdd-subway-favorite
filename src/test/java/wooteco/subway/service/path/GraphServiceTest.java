...
public class GraphServiceTest {
    ...
    @Test
    void findPath() {
        List<Long> stationIds = graphService.findPath(new Lines(Lists.list(line1, line2)), station3.getId(), station5.getId(), PathType.DISTANCE);
    ...
    void findPathWithNoPath() {
        assertThrows(IllegalArgumentException.class, () ->
                graphService.findPath(new Lines(Lists.list(line1, line2)), station3.getId(), station6.getId(), PathType.DISTANCE)
        );
