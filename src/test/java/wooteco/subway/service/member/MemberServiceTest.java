...
public class MemberServiceTest {
	...
	void saveFavorite() {
		...
		Member savedMember = memberService.saveFavorite(member.getId(), favoriteCreateRequest);
	...
	void findAll() {
		...
		List<FavoriteResponse> allFavoritesByMemberId = memberService.findAllFavoritesByMemberId(1L);
