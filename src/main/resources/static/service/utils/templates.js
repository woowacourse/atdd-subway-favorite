...
export const edgeItemTemplate = favorite => {
    return `<div class="list-item border border-gray-200 py-2 px-4 text-gray-800">
    <span class="source-name">${favorite.sourceName}</span>
    <span class="mdi mdi-arrow-right-bold text-gray-500"></span> 
    <span class="destination-name">${favorite.destinationName}</span>
