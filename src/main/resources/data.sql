INSERT INTO MEMBER VALUES ( 1, 'a@a.com', 'a', '1',CURRENT_TIME(), CURRENT_TIME());
...
insert into STATION values (1, '신당', CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP());
insert into STATION values (2, '상왕십리', CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP());
insert into STATION values (3, '왕십리', CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP());
insert into STATION values (4, '한양대', CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP());
insert into STATION values (5, '뚝섬', CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP());
...
insert into FAVORITE values (1,1, 1, 5,CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
